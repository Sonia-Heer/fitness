...
function TrainerBox() {
  ...
  const trainers = [
    { img: Trainer1, name: "Shrek", job: "Yoga Trainer" },
    { img: Trainer2, name: "Lord Farquaad", job: "Crossfit Trainer" },
    { img: Trainer3, name: "Gingy", job: "Personal Trainer" },
  ];
          ...
          >
            ...
            <div className="box-desc bg-white w-full text-center shadow-lg z-20 rounded-[6px] px-[20px] py-[30px] absolute -bottom-[31px]">
              ...
              <div className="flex gap-8 text-[#646464] w-full justify-center mt-5 text-[1.6rem]">
                <i className="fa-brands fa-facebook-f"><BsFacebook/></i>
                <i className="fa-brands fa-instagram"><AiFillInstagram/></i>
                <i className="fa-brands fa-twitter"><BsTwitter/></i>
